    ...
    <Link
      ...
      className={clsx(
        ...
        active
          ...
          : "border-slate-200/70 dark:border-slate-700/80 bg-white/50 dark:bg-slate-900/80 text-slate-600 dark:text-slate-300 hover:border-amber-400/50 hover:bg-amber-50 dark:hover:bg-amber-900/20 hover:text-amber-700 dark:hover:text-amber-100",
      )}
    >
      {label}
    </Link>
